...
@media(max-width:700px){.kp{width:calc(100vw - 112px);right:92px;max-height:78vh}.recruiter-kage .kp{width:calc(100vw - 112px)}.kp-msgs,.recruiter-kage .kp-msgs{max-height:48vh}.kage-stage{width:76px;height:106px}}\
';
